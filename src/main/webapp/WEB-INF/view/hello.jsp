<div id="wrapper">
    <div id="header">
        <h1>Musée d'Orsay
            <span>Musée d'Orsay Musée d'Orsay Musée d'Orsay Musée d'Orsay Musée d'Orsay</span>
        </h1>
        <p class="stit">Royal Academy of Arts, 
            <span>THE REAL VANGOGH </span> THE ARTIST AND HIS LETTERS
        </p>
    </div>
    <div id="container">
        <div class="cover">
        ...
        <dl class="aside">
            ...
            <dd><a href="#">RA collection</a> <span>RA Collections</span></dd>
        </dl>
    </div>
    <div id="footer">
